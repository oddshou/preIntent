...
public class TestPreIntentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.tvNormalInt)).setText(String.valueOf(num));
    }
    //修改num 的值，再进入下一个页面，如果这个页面被杀掉而重新恢复的话，能够恢复修改后的值
    public void getRandomInt(View view){
